"use client";
import { normalizeVehicle } from "@/utils/vehicles/vehicleAPI";
import React, {
    useCallback,
    useEffect,
    useMemo,
...
export default function Listings({
    ...
    useEffect(() => {
        ...
        try {
            ...
            const initialFilters = { ...DEFAULT_FILTERS, ...parsed };
            
            // If URL has a make, override the saved make
            if (urlMake) {
                initialFilters.make = urlMake;
                // reset relative specific filters if make changes via URL
                if (urlMake !== parsed.make) {
                  initialFilters.model = "";
                  initialFilters.model_detail = "";
                }
            }
        ...
        const initData = async () => {
            try {
                ...
                if (makesRes?.data) {
                    ...
                    setMakeIds(makesRes.data.map(item => item.id));
                }

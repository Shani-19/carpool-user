...
export default function RelatedCars({ cars = [] }) {
  const imageBase = "https://media.carpoolkr.com/assets/car/thumbnail/";
    ...
    <section className="cars-section-three">
      <div className="boxcar-container">
        <div className="boxcar-title wow fadeInUp">
          ...
          <Link href="/inventory-page-v1" className="btn-title">
            View All
            <svg
        ...
        >
          {cars.map((car, index) => {
            const imageUrl = car.main_image?.startsWith("http")
              ? car.main_image
              : `${imageBase}${car.main_image}`;

            return (
                <div
                  key={index}
                  className="car-block-three col-lg-3 col-md-6 col-sm-12"
                  onClick={() => window.open(`/vehicles/cars/${car.slug}`, '_blank')}
                ...
                <div className="inner-box">
                  <div className="image-box">
                    <div className="slider-thumb">
                      <div className="image">
                        <Link href={`/vehicles/cars/${car.slug}`} target="_blank">
                          <Image
                            alt={car.name}
                            src={imageUrl}
                            width={329}

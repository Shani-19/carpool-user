...
export default function Header1({
  ...
  return (
    ...
    <>
      {/* 22/4/26 code updated with Maira's Changes START */}
      {/* ===== Maira Edit START -- Top Header Bar ===== */}
      <div className="top-header-bar">
        <div className="top-header-left">
          <span className="top-header-label">Social Media</span>
          <span className="top-header-divider">|</span>
          <a className="top-social-icon" href="https://facebook.com" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
            <i className="fa-brands fa-facebook-f" />
          </a>
          <a className="top-social-icon" href="https://youtube.com" target="_blank" rel="noopener noreferrer" aria-label="YouTube">
            <i className="fa-brands fa-youtube" />
          </a>
          <a className="top-social-icon" href="https://instagram.com" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
            <i className="fa-brands fa-instagram" />
          </a>
          <a className="top-social-icon" href="https://linkedin.com" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
            <i className="fa-brands fa-linkedin-in" />
          </a>
        </div>
        <div className="top-header-right">
          <span className="top-header-phone">
            <i className="fa-solid fa-phone" />
            <strong>Call Our Office: +82-109-484-0471</strong>
          </span>
          <span className="top-header-divider">|</span>
          {isAuthenticated && isClient ? (
            ...
            <>
              ...
              <span className="top-header-divider">|</span>
              <Link href={`/login`} className="top-header-auth">
                Sign In
              </Link>
              <span>or</span>
              <Link href={`/login`} className="top-header-auth">
